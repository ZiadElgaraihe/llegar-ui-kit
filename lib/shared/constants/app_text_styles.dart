...
abstract class AppTextStyles {
  static TextStyle regular10(BuildContext context, {bool responsive = false}) =>
      TextStyle(
        fontSize:
  ...
  static TextStyle bold17(BuildContext context, {bool responsive = false}) =>
      TextStyle(
        fontSize:
            responsive ? _getResponsiveFontSize(context, fontSize: 17) : 17,
        fontWeight: FontWeight.w700,
      );
  ...
  static TextStyle regular24(BuildContext context, {bool responsive = false}) =>
      TextStyle(
        fontSize:
  ...
  static TextStyle semiBold30(BuildContext context,
      ...
      TextStyle(
        fontSize:
            responsive ? _getResponsiveFontSize(context, fontSize: 30) : 30,
        fontWeight: FontWeight.w600,
      );
